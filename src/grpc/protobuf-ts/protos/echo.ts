...
// @generated from protobuf file "protos/echo.proto" (package "helloworld", syntax proto3)
// tslint:disable
//
...
/**
 * @generated from protobuf message helloworld.RepeatHelloRequest
 */
export interface RepeatHelloRequest {
    /**
     * @generated from protobuf field: string name = 1;
     */
    name: string;
...
// @generated message type with reflection information, may provide speed optimized methods
class RepeatHelloRequest$Type extends MessageType<RepeatHelloRequest> {
    constructor() {
        super("helloworld.RepeatHelloRequest", [
            { no: 1, name: "name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "count", kind: "scalar", T: 5 /*ScalarType.INT32*/ }
        ]);
    }
    create(value?: PartialMessage<RepeatHelloRequest>): RepeatHelloRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.name = "";
        message.count = 0;
        if (value !== undefined)
            reflectionMergePartial<RepeatHelloRequest>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: RepeatHelloRequest): RepeatHelloRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: RepeatHelloRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string name = 1; */
        if (message.name !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.name);
        /* int32 count = 2; */
...
/**
 * @generated MessageType for protobuf message helloworld.RepeatHelloRequest
 */
export const RepeatHelloRequest = new RepeatHelloRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
export const Greeter = new ServiceType("helloworld.Greeter", [
    ...
    { name: "SayRepeatHello", serverStreaming: true, options: {}, I: RepeatHelloRequest, O: HelloReply }
]);
